...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Buick GMC MA"],
    ["successTitle", "¡Gracias! - Quirk Buick GMC MA"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Buick GMC MA se pondrá en contacto con usted en breve."]
  ]);
